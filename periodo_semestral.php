	...
	<div class="container-fluid">
		...
		<?php include ('../menu_head.php');?>
			...
			<div class="contenido">
				<div class="col-md-2">	
					<div class="sidebar">
						<ul class="nav nav-pills nav-stacked">
							...
							<li><a href="calendario_academico.php" data-toggle="tooltip" data-placement="right" title="Calendario Académico">Calendario Académico</a></li>
							<li class="active"><a href="periodo_semestral.php" data-toggle="tooltip" data-placement="right" title="Periodo Semestral">Periodo Semestral</a></li>
				...
				<div class="col-md-10">
					<div class="side">
						<h1 class="titulo">PERIODO SEMESTRAL</h1>
						<?php
